...
A public URL does not imply redistribution permission. Repository publication never broadens source rights. Keep acquisition credentials and non-admitted source bytes outside Git.

Coding agents use the same public repository state and contribution path as human contributors; see `AGENTS.md`.
