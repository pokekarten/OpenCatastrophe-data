...
from scripts import run_esrm20_event_hazard_group2_imt_profile_action as action

EXECUTION_SHA = "b" * 40


class Group2ImtProfileTerminalSizeTests(unittest.TestCase):
    def _assert_rejected_before_json(self, body: str, message: str) -> None:
        with mock.patch.object(
            ...
            with self.assertRaisesRegex(action.Group2ImtProfileActionError, message):
