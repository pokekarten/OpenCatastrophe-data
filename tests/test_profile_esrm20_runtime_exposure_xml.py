...
NS = subject.NRML_NAMESPACE
VALID = f'''<?xml version="1.0" encoding="UTF-8"?>
<nrml xmlns="{NS}"><exposureModel id="kosovo" category="buildings" taxonomySource="GEM">
...
class ProfileTests(unittest.TestCase):
    ...
    def test_parser_rejects_dtd_foreign_namespace_unknown_children_and_unsafe_assets(self):
        cases = [
            ...
            f'<nrml xmlns="{NS}"><exposureModel id="x"><description>x</description><assets>a.csv</assets><mystery/></exposureModel></nrml>'.encode(),
            f'<nrml xmlns="{NS}"><exposureModel id="x"><description>x</description><assets>../a.csv</assets></exposureModel></nrml>'.encode(),
            f'<nrml xmlns="{NS}"><exposureModel id="x"><description>x</description><assets>./a.csv</assets></exposureModel></nrml>'.encode(),
