...
class EbriskV10TreeTerminalBoundTests(unittest.TestCase):
    def _assert_rejected_before_json(self, body: str, message: str) -> None:
        with mock.patch.object(
            ...
            with self.assertRaisesRegex(action.EbriskTreeExecutionError, message):
                action._terminal_result_execution_sha(body)
