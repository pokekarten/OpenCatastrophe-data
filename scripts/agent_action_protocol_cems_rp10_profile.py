...
"""Extend Agent Action semantic identity for the trusted CEMS RP10 profile."""
...
try:
    from scripts import agent_action_protocol_cems_rp10 as _legacy
except ModuleNotFoundError:  # pragma: no cover - direct script import path
    import agent_action_protocol_cems_rp10 as _legacy
...
def semantic_request_id(
    ...
    if (
        ...
        and request.get("action") == CEMS_RP10_PROFILE_ACTION
