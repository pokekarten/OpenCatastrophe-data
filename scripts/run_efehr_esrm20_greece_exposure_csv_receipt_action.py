...
"""Closed wrapper that preserves a Greece-exposure-CSV terminal on ledger failure."""
...
_LEDGER_FAILURE_MESSAGE = "cannot read complete Greece exposure CSV result ledger"
...
def prepare_action_result(
    ...
    *,
    ...
    except worker.GreeceExposureCsvReceiptError as exc:
...
def main(argv: list[str] | None = None) -> int:
    ...
    if body is None:
        raise worker.GreeceExposureCsvReceiptError(
