...
"""Extend Agent Action semantic identity for CEMS companion-mask profiles."""
...
try:
    from scripts import agent_action_protocol_cems_masks as _legacy
except ModuleNotFoundError:  # pragma: no cover
    import agent_action_protocol_cems_masks as _legacy
...
def semantic_request_id(
    ...
    if (
        ...
        and request.get("action") == CEMS_MASK_PROFILES_ACTION
