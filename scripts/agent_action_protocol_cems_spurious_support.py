...
"""Extend Agent Action semantic identity for the CEMS Stage-D support challenge."""
...
try:
    from scripts import agent_action_protocol_cems_mask_values as _legacy
except ModuleNotFoundError:  # pragma: no cover
    import agent_action_protocol_cems_mask_values as _legacy
...
def semantic_request_id(
    ...
    if (
        ...
        and request.get("action") == CEMS_SPURIOUS_SUPPORT_ACTION
