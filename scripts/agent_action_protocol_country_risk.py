...
"""Extend Agent Action semantic identity for the fixed country-risk network action."""
...
try:
    from scripts import agent_action_protocol as _legacy
except ModuleNotFoundError:  # pragma: no cover - direct script import path
    import agent_action_protocol as _legacy
...
def semantic_request_id(
    ...
    if (
        ...
        and request.get("action") == ESRM20_COUNTRY_RISK_RECEIPT_ACTION
