...
"""Closed wrapper preserving a Greece exposure three-CSV terminal on ledger failure."""
...
_LEDGER_FAILURE_MESSAGE = "cannot read complete Greece exposure CSV receipts result ledger"
...
def prepare_action_result(
    ...
    *,
    ...
    except worker.GreeceExposureCsvReceiptsError as exc:
...
def main(argv: list[str] | None = None) -> int:
    ...
    if body is None:
        raise worker.GreeceExposureCsvReceiptsError(
