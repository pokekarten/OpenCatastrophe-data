...
"""Extend Agent Action semantic identity for CEMS Issue #835 diagnostics."""
...
try:
    from scripts import agent_action_protocol_cems_spurious_support as _legacy
except ModuleNotFoundError:  # pragma: no cover
    import agent_action_protocol_cems_spurious_support as _legacy
...
def semantic_request_id(
    ...
    if (
        ...
        and request.get("action") == CEMS_SPURIOUS_FALSIFIER_DIAGNOSTICS_ACTION
