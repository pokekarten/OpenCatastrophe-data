...
"""Trusted acquisition worker for the frozen ESRM20 exposure-vulnerability mapping.
...
OPERATION_ID = "esrm20-exposure-vulnerability-mapping-v1"
SOURCE_ISSUE = 283
...
def acquire_esrm20_mapping_receipt(
    *,
    opener: Any | None = None,
    now: Any = utc_now,
    monotonic: Any = time.monotonic,
) -> dict[str, Any]:
    """Fetch only the frozen ESRM20 mapping object and return its byte receipt.
