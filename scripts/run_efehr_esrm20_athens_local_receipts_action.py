...
"""Closed wrapper that terminalizes the Athens-local ledger-read failure."""
...
from scripts import acquire_efehr_esrm20_athens_local_receipts as worker

_LEDGER_FAILURE_MESSAGE = "cannot read complete Athens-local result ledger"
...
def prepare_action_result(
    ...
    *,
    ...
    except worker.AthensLocalReceiptError as exc:
...
def main(argv: list[str] | None = None) -> int:
    ...
    if body is None:
        raise worker.AthensLocalReceiptError(
