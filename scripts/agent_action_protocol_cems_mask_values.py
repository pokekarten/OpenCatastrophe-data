...
"""Extend Agent Action semantic identity for CEMS companion-mask value inventories."""
...
try:
    from scripts import agent_action_protocol_cems_mask_profiles as _legacy
except ModuleNotFoundError:  # pragma: no cover
    import agent_action_protocol_cems_mask_profiles as _legacy
...
def semantic_request_id(
    ...
    if (
        ...
        and request.get("action") == CEMS_MASK_VALUE_INVENTORIES_ACTION
