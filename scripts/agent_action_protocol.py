...
def semantic_request_id(request: dict[str, Any], execution_sha: str, repository: str) -> str:
    ...
    tree-metadata, Kosovo exposure, ESRM20 mapping receipt/header disclosure,
    ESHM20 root-config, GMM resource profiling and ESRM20 Group1/Group2
    event-hazard receipts distinct without introducing a caller-controlled
    network target.
    """
